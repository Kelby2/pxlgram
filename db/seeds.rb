...
user5 = User.create!(username: 'pxlg', password: 'password', fullname: 'Pxlgram', email: 'pxlg@pxlgram.com', bio: 'Welcome to pxlgram!', avatar: File.open('app/assets/images/pxlgram_logo.jpg'))
