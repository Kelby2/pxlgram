...
Photo.create!(author_id: 7, caption: 'this is photo #7')
Photo.create!(author_id: 8, caption: 'this is from beyonce ig')
Photo.create!(author_id: 9, caption: 'This will be a great photo')
Photo.create!(author_id: 10, caption: 'This will be a great photo')
Photo.create!(author_id: 11, caption: 'jayz put a ring on me')
