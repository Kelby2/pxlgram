...
user10 = User.create!(username: 'kingjames', password: 'password', fullname: 'Lebron Raymone James', email: 'user11@pxlgram.com', avatar: File.open('app/assets/images/cavs.png'), bio: '#23')
