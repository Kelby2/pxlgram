...
Photo.create!(author_id: 2, caption: 'This will be a great photo')
Photo.create!(author_id: 3, caption: 'This will be a great photo')
Photo.create!(author_id: 4, caption: 'This will be a great photo')
Photo.create!(author_id: 5, caption: 'This will be a great photo')
Photo.create!(author_id: 6, caption: 'This will be a great photo')
Photo.create!(author_id: 7, caption: 'This will be a great photo')
Photo.create!(author_id: 8, caption: 'This will be a great photo')
Photo.create!(author_id: 9, caption: 'This will be a great photo')
Photo.create!(author_id: 10, caption: 'This will be a great photo')
Photo.create!(author_id: 11, caption: 'This will be a great photo')
Photo.create!(author_id: 3, caption: 'This will be a great photo')
